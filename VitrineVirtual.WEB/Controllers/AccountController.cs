...
namespace VitrineVirtual.WEB.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private IdentityUserRole iur = new IdentityUserRole();
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
                    ...
                    if (user != null)
                    {
                        ...
                        switch (result)
                        {
                            ...
                            case SignInStatus.Failure:
                                ...
                                return View(model);
                            default:
                                ModelState.AddModelError("", "Excedeu o número de tentativas.");
                                return View(model);
                        }
            ...
            //TODO
            // Verificar qual tipo de usuário e armazenar na section o usuário e o tipo de usuário.
            // Seja por DataAnnotation ou Razor
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                Model.CUA_Usuarios insereUsuario = new Model.CUA_Usuarios();
                ...
                if (result.Succeeded)
                {
                    ...
                    // Checar o dropdown qual tipo de usuário.
                    var roleresult = UserManager.AddToRole(currentUser.Id, "Visitante");
                    Session["ID_Usuario"] = user.Id;
                    Session["Email"] = user.Email;
                    Session["UserName"] = user.UserName;

                    insereUsuario.id = user.Id;
                    insereUsuario.Email = user.Email;
                    insereUsuario.Login_Usuario = user.UserName;
                    db.Usuarios.Add(insereUsuario);

                    return RedirectToAction("Create", "CUAUsuarios");
                }
                AddErrors(result);
            }
