...
namespace VitrineVirtual.WEB
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            // jQueryUI CSS
            bundles.Add(new ScriptBundle("~/plugins/jquery-ui/jqueryuiStyles").Include(
            ...
            bundles.Add(new StyleBundle("~/plugins/unobtrusive").Include(
                        "~/Scripts/jquery.unobtrusive-ajax.js.js"));

            bundles.Add(new StyleBundle("~/plugins/unobtrusiveMin").Include(
